...
def get_args():
    ...
    parser.add_argument("--activation_function", type=str, default="complex_relu", choices=["complex_relu", "modReLU", "zReLU", "cardioid"])
    parser.add_argument("--sampler_filename", type=str, default="/gpfs/data/chopralab/zineb_project/fastMRI/MRI/complex_classification/sampler_knee_tr.p")
    parser.add_argument(
        "--model_type",
        type=str,
