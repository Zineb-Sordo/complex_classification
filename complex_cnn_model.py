...
class ComplexPreActResNetFFTKnee(pl.LightningModule):
    ...
    def forward(self, kspace):
        ...
        # print("layer2 shape is {}".format(layer_1_out.shape))
        layer_3_out = self.layer3(layer_2_out)
        # print("layer3 shape is {}".format(layer_1_out.shape))
        layer_4_out = self.layer4(layer_3_out)
        # print("layer4 shape is {}".format(layer_1_out.shape))
        out = complex_avg_pool2d(layer_4_out, 4)
        # print("complex_avg_pool2d shape is {}".format(layer_1_out.shape))
        out = out.view(out.size(0), -1)
        # print("out.view shape is {}".format(layer_1_out.shape))
        #out = self.dropout(out)
