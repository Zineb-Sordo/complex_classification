...
def get_args():
    ...
    parser.add_argument("--coil_type", type=str, default="sc", choices=["sc", "mc", "sc_scaled"])
    parser.add_argument("--activation_function", type=str, default="complex_relu", choices=["complex_relu", "modReLU", "zReLU"])
